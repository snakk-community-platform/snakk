...
(function() {
     ...
     */
    function initializeProfile(userId: string, currentTab: string, stats: UserStats): void {
        // Load user stats
        ...
        async function loadAllDiscussions(): Promise<void> {
        ...
        // Top Contributions
        async function loadTopContributions(): Promise<void> {
            ...
            try {
                ...
                container.innerHTML = data.items.map((discussion: any, index: number) => `
