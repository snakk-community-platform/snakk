...
public interface IAllowedTypesService
{
    ...
    /// </summary>
    Task<List<DiscussionTypeEnum>> GetCommunityAllowedTypesAsync(string communityPublicId);
    ...
    /// </summary>
    Task<List<DiscussionTypeEnum>> GetHubEffectiveAllowedTypesAsync(string hubPublicId);
    ...
    /// </summary>
    Task<List<DiscussionTypeEnum>> GetSpaceEffectiveAllowedTypesAsync(string spacePublicId);

    /// <summary>
    /// Get the parent (community) allowed types for a hub — used by admin UI to grey out disabled types.
    /// </summary>
    Task<List<DiscussionTypeEnum>> GetParentAllowedTypesForHubAsync(string hubPublicId);

    /// <summary>
    /// Get the parent (hub effective) allowed types for a space — used by admin UI to grey out disabled types.
    /// </summary>
    Task<List<DiscussionTypeEnum>> GetParentAllowedTypesForSpaceAsync(string spacePublicId);
}
