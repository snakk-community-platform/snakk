...
public interface IActivityBroadcaster
{
    ...
    Task BroadcastDiscussionCreated(
        string userId,
        string username,
        string discussionId,
        string discussionTitle,
    ...
    Task BroadcastModerationAction(
        string moderatorId,
