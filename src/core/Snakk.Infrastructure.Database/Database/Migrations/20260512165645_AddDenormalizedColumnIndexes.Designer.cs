...
namespace Snakk.Infrastructure.Database.Database.Migrations
{
    ...
    [Migration("20260512165645_AddDenormalizedColumnIndexes")]
    partial class AddDenormalizedColumnIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Snakk.Infrastructure.Database.Entities.DiscussionDatabaseEntity", b =>
                {
                    ...
                    b.HasIndex("CommunityPublicId", "LastActivityAt", "Id")
                        .IsDescending(false, true, true)
                        .HasDatabaseName("IX_Discussion_CommunityPublicId_LastActivityAt_Id_NotDeleted")
                        .HasFilter("\"IsDeleted\" = FALSE");
                    ...
                    b.HasIndex("HubPublicId", "LastActivityAt", "Id")
                        .IsDescending(false, true, true)
                        .HasDatabaseName("IX_Discussion_HubPublicId_LastActivityAt_Id_NotDeleted")
                        .HasFilter("\"IsDeleted\" = FALSE");

                    b.HasIndex("SpacePublicId", "LastActivityAt", "Id")
                        .IsDescending(false, true, true)
                        .HasDatabaseName("IX_Discussion_SpacePublicId_LastActivityAt_Id_NotDeleted")
                        .HasFilter("\"IsDeleted\" = FALSE");
            ...
            modelBuilder.Entity("Snakk.Infrastructure.Database.Entities.PostDatabaseEntity", b =>
                {
                    ...
                    b.HasIndex("CommunityPublicId", "CreatedAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("IX_Post_CommunityPublicId_CreatedAt_NotDeleted")
                        .HasFilter("\"IsDeleted\" = FALSE");
                    ...
                    b.HasIndex("DiscussionPublicId", "CreatedAt")
                        .HasDatabaseName("IX_Post_DiscussionPublicId_CreatedAt_NotDeleted")
                        .HasFilter("\"IsDeleted\" = FALSE");
                    ...
                    b.HasIndex("HubPublicId", "CreatedAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("IX_Post_HubPublicId_CreatedAt_NotDeleted")
                        .HasFilter("\"IsDeleted\" = FALSE");
                    ...
                    b.HasIndex("SpacePublicId", "CreatedAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("IX_Post_SpacePublicId_CreatedAt_NotDeleted")
                        .HasFilter("\"IsDeleted\" = FALSE");
            ...
            modelBuilder.Entity("Snakk.Infrastructure.Database.Entities.SpaceDatabaseEntity", b =>
                {
                    ...
                    b.HasIndex("HubPublicId")
                        .HasDatabaseName("IX_Space_HubPublicId_NotDeleted")
                        .HasFilter("\"IsDeleted\" = FALSE");
