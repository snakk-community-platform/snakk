...
public class BffMiscTests
{
    ...
    public async Task GetHomepageData_ReturnsAggregatedDataFromAllApis()
    {
        ...
        app.MockApiClient
            .GetRecentDiscussionsAsync(0, 10, null, Arg.Any<string?>(), Arg.Any<string?>(), Arg.Any<string?>(), Arg.Any<string?>(), Arg.Any<IReadOnlyList<string>?>(), Arg.Any<bool>(), Arg.Any<bool>(), Arg.Any<bool>(), Arg.Any<CancellationToken>())
