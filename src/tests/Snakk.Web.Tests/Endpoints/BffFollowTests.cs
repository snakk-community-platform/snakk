...
public class BffFollowTests
{
    ...
    public async Task GetSpaceFollowStatus_ReturnsFollowingStatus()
    {
        ...
        app.MockApiClient
            .GetSpaceFollowStatusAsync(Arg.Any<string>(), Arg.Any<CancellationToken>())
    ...
    public async Task ToggleSpaceFollow_ReturnsUpdatedFollowState()
    {
        ...
        await using var app = new TestWebApp();
        app.MockApiClient
            .ToggleSpaceFollowResultAsync(Arg.Any<string>(), Arg.Any<string?>(), Arg.Any<CancellationToken>())
    ...
    public async Task GetDiscussionFollowStatus_ReturnsFollowingStatus()
    {
        ...
        await using var app = new TestWebApp();
        app.MockApiClient
            .GetDiscussionFollowStatusAsync(Arg.Any<string>(), Arg.Any<CancellationToken>())
    ...
    public async Task ToggleDiscussionFollow_ReturnsUpdatedFollowState()
    {
        ...
        await using var app = new TestWebApp();
        app.MockApiClient
            .ToggleDiscussionFollowResultAsync(Arg.Any<string>(), Arg.Any<CancellationToken>())
    ...
    public async Task GetUserFollowStatus_ReturnsFollowingStatus()
    {
        ...
        await using var app = new TestWebApp();
        app.MockApiClient
            .GetUserFollowStatusAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(new FollowToggleResponse { IsFollowing = true });
    ...
    public async Task ToggleUserFollow_ReturnsUpdatedFollowState()
    {
        ...
        await using var app = new TestWebApp();
        app.MockApiClient
            .ToggleUserFollowResultAsync(Arg.Any<string>(), Arg.Any<CancellationToken>())
            .Returns(GrpcResult<FollowToggleResponse>.Ok(
    ...
    public async Task GetFollowedSpaces_ReturnsListOfPublicIds()
    {
        ...
        await using var app = new TestWebApp();
        app.MockApiClient
            .GetFollowedSpacesAsync(Arg.Any<CancellationToken>())
    ...
    public async Task GetFollowedDiscussions_ReturnsListOfPublicIds()
    {
        ...
        await using var app = new TestWebApp();
        app.MockApiClient
            .GetFollowedDiscussionsAsync(Arg.Any<CancellationToken>())
    ...
    public async Task GetFollowedUsers_ReturnsListOfPublicIds()
    {
        ...
        await using var app = new TestWebApp();
        app.MockApiClient
            .GetFollowedUsersAsync(Arg.Any<CancellationToken>())
