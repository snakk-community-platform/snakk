namespace Snakk.PublicApi.Models;
...
public record PollPreview(
    [property: JsonPropertyName("options")] IReadOnlyList<PollPreviewOption> Options,
...
public record ImagesPreview(
    ...
    [property: JsonPropertyName("items")] IReadOnlyList<ImagePreviewItem> Items,
...
public record DiscussionListItem(
    ...
    [property: JsonPropertyName("space")] EntitySummary? Space,
    [property: JsonPropertyName("hub")] EntitySummary? Hub,
